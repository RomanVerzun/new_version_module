...
class MODULE:
    ...
    def iterate_upper_Inp1(self):
        return self.upper_boardInp.iter_line1()
    
    def iterate_upper_Inp2(self):
        return self.upper_boardInp.iter_line2()
    
    def iterate_down_Inp1(self):
        return self.down_boardInp.iter_line1()
    
    def iterate_down_Inp2(self):
        return self.down_boardInp.iter_line2()
    
    def iterate_upper_Out1(self):
        return self.upper_boardOut.iter_line1()
    
    def iterate_upper_Out2(self):
        return self.upper_boardOut.iter_line2()
    
    def iterate_down_Out1(self):
        return self.down_boardOut.iter_line1()
